...
[**`examples/simple/main.py`**](https://github.com/humblebeeai/rest.fastapi-orm-template/blob/main/examples/simple/main.py):
...
[**`examples/async/main.py`**](https://github.com/humblebeeai/rest.fastapi-orm-template/blob/main/examples/async/main.py):
